        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Histories_AspNetUsers_ChangedById",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkLogHtml = table.Column<string>(type: "TEXT", nullable: false),
                    WorkLogText = table.Column<string>(type: "TEXT", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    IsDeleted = table.Column<bool>(type: "INTEGER", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "TEXT", nullable: true)
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Histories_ChangedAt",
                table: "Histories",
                column: "ChangedAt");

            migrationBuilder.CreateIndex(
                name: "IX_Histories_ChangedById",
                table: "Histories",
                column: "ChangedById");

            migrationBuilder.CreateIndex(
                name: "IX_Histories_Entity_EntityId",
                table: "Histories",
